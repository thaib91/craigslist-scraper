...
const scrapeResult = {
    ...
    url: "https://denver.craigslist.org/apa/d/englewood-cozy-home-perfectly-suited/6833612198.html",
...
const scrapeCraigslist = async () => { //function to take in html data (into string) of webpage into terminal
    try{
